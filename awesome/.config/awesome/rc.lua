...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey, "Shift" }, "y", function() awful.tag.incmwfact(-0.05) end,
    ...
    awful.key({ modkey }, "c", function() awful.spawn("code") end,
        { description = "visual studio code", group = "launcher" }),
    ...
    awful.key({}, "XF86AudioMicMute", function() awful.util.spawn("amixer -D pulse sset Capture toggle", false) end),
